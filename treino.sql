...
values ( 'O que é uma chave primária?', 1),
( 'Diferença entre chave primária e estrangeira?', 1),
('Explique normalização até 3FN.', 1),
( 'O que é SQL?', 1),
( 'Para que serve um índice?', 1),


( 'O que significa HTML?', 2),
( 'Explique a diferença entre HTTP e HTTPS.', 2),
('Explique o conceito de REST.', 2),
( 'O que é CSS?', 2),
( 'Qual a função do JavaScript no front-end?', 2),


( 'O que é crime doloso?', 3),
( 'Quais são os elementos do tipo penal?', 3),
('Explique a teoria finalista da ação.', 3),
( 'Defina crime culposo.', 3),
( 'Qual a diferença entre tentativa e consumação?', 3),


( 'O que é pessoa natural?', 4),
( 'Diferença entre pessoa física e jurídica.', 4),
('Explique o conceito de capacidade civil.', 4),
( 'O que é domicílio civil?', 4),
( 'Qual a diferença entre bens móveis e imóveis?', 4),


( 'Quantos ossos possui o corpo humano adulto?', 5),
( 'Qual a função do esqueleto axial?', 5),
('Nome dos ossos do antebraço.', 5),
( 'Onde fica o fêmur?', 5),
( 'Diferença entre ossos longos e curtos.', 5),


('Qual órgão controla os batimentos cardíacos?', 6),
('Explique a função do cerebelo.', 6),
('O que é homeostase?', 6),
('Função dos neurônios motores.', 6),
('Explique sinapse elétrica e química.', 6),


('O que é fluxo de caixa?', 7),
('Diferença entre ativo e passivo.', 7),
('Explique o conceito de valor presente líquido (VPL).', 7),
('O que é capital de giro?', 7),
('Qual a diferença entre receita e lucro?', 7),


('Defina psicologia clínica.', 8),
('Explique transferência e contratransferência.', 8),
( 'Explique o inconsciente segundo Freud.', 8),
('O que é uma entrevista clínica?', 8),
('Explique diagnóstico diferencial.', 8),


( 'O que é uma pilha (stack)?', 9),
( 'Complexidade da busca binária.', 9),
('Explique árvores balanceadas.', 9),
( 'O que é uma fila (queue)?', 9),
( 'Diferença entre array e lista encadeada.', 9),


('O que é aprendizado supervisionado?', 10),
('Explique aprendizado não supervisionado.', 10),
( 'Defina redes neurais convolucionais.', 10),
('O que é regressão linear?', 10),
('Explique overfitting em modelos de IA.', 10);

insert into alternativas (testo, correta, idQuestoes)
values ('Identificador único que identifica cada registro na tabela', 1, 1),
...
INSERT INTO resultado (tempo, dataexecucao, idUsuario, idQuestionario, pontuacao) VALUES
(380, '2025-09-01 09:10:00', 1, 1,100),
(420, '2025-09-01 10:00:00', 2, 2,200),
(510, '2025-09-02 11:20:00', 3, 3,300),
(295, '2025-09-02 14:05:00', 4, 4,400),
(330, '2025-09-03 08:30:00', 5, 5,500),
(600, '2025-09-03 16:40:00', 6, 6,600),
(470, '2025-09-04 12:15:00', 7, 7,700),
(385, '2025-09-04 18:50:00', 8, 8,800),
(360, '2025-09-05 09:00:00', 9, 9,500),
(540, '2025-09-05 20:10:00',10,10,400),
(420, '2025-09-06 11:11:00',11,1,300),
(310, '2025-09-06 15:30:00',12,2,200),
(310, '2025-09-06 15:30:00',12,4,200);

INSERT INTO respostas (idUsuario, idQuestoes, idAlternativas, correta, idResultado) VALUES
